...
- Learned how to create & manage workspaces and projects  
...
- OCI Data Labeling – created labeled datasets for training  

### 5️⃣ Best Practices & Business Use
- Cloud security best practices (IAM, encryption, access control)  
- Optimized for scalability & cost using flexible compute options  
- Applied ML to real business problems like churn prediction, forecasting, and NLP  

---

## 🎥 My Experience & Presentation

[Link to my demo/video/slides here]
...
- Automate retraining and monitoring with MLOps  
...
`OCI Vault`, `Object Storage`, `OCI Data Flow`, `OCI Data Labeling`  
